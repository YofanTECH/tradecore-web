      ...
      <section className="pt-32 pb-20 px-6">
         <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8 text-gray-400 leading-relaxed text-sm">
                ...
                <p>TradeCore is constantly innovating in order to provide the best possible experience for its users. You acknowledge and agree that the form and nature of the services which TradeCore provides may change from time to time without prior notice to you.</p>
