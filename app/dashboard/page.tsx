...
// ============================================================================
// AI SUPPORT CHAT COMPONENT (DASHBOARD VERSION)
// ============================================================================
    ...
    return (
        <>
            <div
                ...
                onClick={handleClick}
                style={{ right: `${position.x}px`, bottom: `${position.y}px`, cursor: isDragging ? 'grabbing' : 'pointer', touchAction: 'none' }}
                ...
                <div className="max-w-6xl mx-auto space-y-6 md:space-y-8 animate-in fade-in zoom-in-95 duration-300">
                    ...
                    {accounts.length === 0 ? (
                        <div className="bg-[#111] border border-white/5 rounded-2xl p-6 md:p-12 h-[280px] md:h-[350px] flex flex-col items-center justify-center text-center px-4">
                            ...
                            {/* ADDED PLATFORM INFO HERE */}
                            <div className="mt-8 border-t border-white/5 pt-6 grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-2xl text-[10px] md:text-xs text-gray-500">
                                <div className="flex flex-col items-center">
                                    <span className="text-white font-bold mb-1">0.0 Pips</span>
                                    Raw Spreads
                                </div>
                                <div className="flex flex-col items-center">
                                    <span className="text-white font-bold mb-1">1:1000</span>
                                    Max Leverage
                                </div>
                                <div className="flex flex-col items-center">
                                    <span className="text-white font-bold mb-1">0% Fees</span>
                                    Crypto Funding
                                </div>
                                <div className="flex flex-col items-center">
                                    <span className="text-white font-bold mb-1">MT4 & MT5</span>
                                    Full Support
                                </div>
                            </div>
                        </div>
